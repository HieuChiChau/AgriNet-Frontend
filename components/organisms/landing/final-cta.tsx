...
export function LandingFinalCTA() {
  return (
    <section className="container py-20">
      <Card className="overflow-hidden border-2 border-green-200 bg-gradient-to-br from-green-50 via-white to-amber-50 shadow-2xl">
        <div className="grid gap-8 lg:grid-cols-[1.2fr,0.8fr]">
          ...
          <CardContent className="relative flex items-center justify-center bg-gradient-to-br from-green-100/60 to-yellow-50">
            <div className="absolute left-6 top-6 h-16 w-16 rounded-full bg-white/50 blur-xl" />
            <div className="absolute bottom-4 right-6 h-20 w-20 rounded-full bg-amber-200/60 blur-3xl" />
            <Image
