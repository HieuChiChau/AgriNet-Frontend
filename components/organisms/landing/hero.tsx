...
export function LandingHero() {
  return (
    <section className="container relative overflow-hidden py-20">
      <div className="absolute inset-0 bg-gradient-to-r from-green-100/40 via-transparent to-yellow-100/60 blur-3xl" />
      <div className="relative grid gap-12 lg:grid-cols-[1.05fr,0.95fr]">
        <div className="space-y-8 text-center lg:text-left">
          <div className="inline-flex items-center gap-2 rounded-full bg-white/80 px-4 py-2 text-sm font-medium text-green-700 shadow">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl md:text-6xl lg:text-6xl">
          ...
          <div className="grid gap-6 rounded-3xl border border-green-100 bg-white/80 p-6 shadow-lg sm:grid-cols-2">
            <div>
        ...
        <div className="relative">
          <div className="absolute -top-6 -left-6 h-32 w-32 rounded-3xl bg-gradient-to-br from-green-200 to-yellow-100 blur-3xl" />
          <div className="absolute -bottom-10 -right-6 h-40 w-40 rounded-full bg-gradient-to-br from-yellow-200 to-green-100 blur-3xl" />
          <div className="relative">
            <Image
            ...
            />
            <div className="absolute -left-6 top-8 rounded-2xl border border-green-100 bg-white/90 px-4 py-3 text-sm shadow-lg">
            ...
            <div className="absolute -right-4 bottom-6 rounded-2xl border border-amber-100 bg-white/90 px-4 py-3 text-sm shadow-lg">
